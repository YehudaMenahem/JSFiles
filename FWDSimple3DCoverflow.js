...
(function (){
    var FWDS3DCovCategoriesButton = function(
        ...
        this.onClick = function(e){
            if(document.getElementById("coverflow_main-fluidwidth").classList.contains("coverflow_disabled")) return;
            if(self.isDisabled) return;
        ...
        this.thumbClickHandler = function()
        {
            ...
            else
            {
                ...
                if (type == "link")
                {
                    ...
                    self.parent.dispatchEvent(FWDS3DCovThumbsManager.THUMB_CLICK, {id:tempId,url:self.curDataListAr[self.curId].secondObj.url});
                }else
                {
...
(function (window){
    ...
    FWDS3DCovUtils.hitTest = function(target, x, y){
        var hit = false;
        if(!target) throw Error("Hit old-test target is null!");
...
(function(window)
{
    var FWDSimple3DCoverflow = function(props)
    {
        ...
        this.init = function()
        {
            ...
            if (!self.propsObj)
            {
                console.log("FWDSimple3DCoverflow properties object is undefined!");
                return;
            }
            ...
            {
                console.log("Property coverflowHolderDivId is not defined in the FWDSimple3DCoverflow object constructor!");
                return;
            }
            if (!FWDS3DCovUtils.getChildById(self.propsObj.coverflowHolderDivId))
            {
                ...
                console.log("FWDSimple3DCoverflow holder div is not found, please make sure that the div exists and the id is correct! " + self.propsObj.coverflowHolderDivId);
                return;
            }

            if (!self.propsObj.coverflowWidth)
            {
                console.log("The coverflow width is not defined, plese make sure that the coverflowWidth property is definded in the FWDSimple3DCoverflow constructor!");
                return;
            }

            if (!self.propsObj.coverflowHeight)
            {
                console.log("The coverflow height is not defined, plese make sure that the coverflowHeight property is definded in the FWDSimple3DCoverflow constructor!");
                return;
            }
